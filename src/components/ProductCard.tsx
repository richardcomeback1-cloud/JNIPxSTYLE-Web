...
// React.memo กันไม่ให้การ์ดสินค้าทุกใบ re-render ตามกัน
// เวลามีอะไรเปลี่ยนที่ parent/context ที่ไม่เกี่ยวกับตัวมันเอง (เช่น เปิด/ปิดตะกร้า)
// จะ re-render เฉพาะใบที่ product prop เปลี่ยนจริง ๆ เท่านั้น
